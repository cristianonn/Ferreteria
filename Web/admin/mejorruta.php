<?php
     ...
     * mejorruta.php - Ver ganancias por ruta
    ...
    $arrayRutas = getMejoresRutas((string) $fecha1db, (string) $fecha2db);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <?php include("toolbar.php"); ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mejores rutas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <form role="form" action="mejorruta.php" method="GET" class="registration-form">
