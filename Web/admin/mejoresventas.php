<?php
     ...
     * inventario.php - Ver productos por ferretería
    ...
    $arrayProductos = getVentasPorFerreteria();
?>
...
<head>
    ...
    <title>Recuento de ventas</title>
...
<body>
    ...
    <?php include("toolbar.php"); ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Recuento de ventas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
