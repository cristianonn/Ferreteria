    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="ferreterias.php"><i class="fa fa-building-o" aria-hidden="true"></i> Ferreterías</a></li>
                <!-- <li><a href="#"><i class="fa fa-comments" aria-hidden="true"></i> Chat</a></li> -->
                <li><a href="carrito.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Carrito:
                <?php
